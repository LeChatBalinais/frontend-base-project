...
exports.ACTION_ID = 'SAGA_TAGS_FETCHED';
exports.actionCreator = make_action_creator_1.makeActionCreator(exports.ACTION_ID);
const getTags = (state, { tags }) => tags;
const getNewTags = (tags) => tags;
exports.reducer = create_reducer_1.createReducer(exports.ACTION_ID, [
    [entities_2.getTagsTable, entities_1.setTags, map_state_to_determiner_1.mapStateToDeterminer(getNewTags, [getTags])]
]);
//# sourceMappingURL=saga-tags-fetching-fetched.js.map